...
void setup() {
  ...
  mpu.setXAccelOffset(-547); //Set your accelerometer offset for axis X
  mpu.setYAccelOffset(-1486); //Set your accelerometer offset for axis Y
  mpu.setZAccelOffset(464); //Set your accelerometer offset for axis Z
  mpu.setXGyroOffset(-150);  //Set your gyro offset for axis X
  mpu.setYGyroOffset(-35);  //Set your gyro offset for axis Y
  mpu.setZGyroOffset(-3);  //Set your gyro offset for axis Z
...
void loop() {
  ...
  /*Print the obtained data on the defined format*/
    ...
    Serial.print(az-16382); Serial.print(",");
